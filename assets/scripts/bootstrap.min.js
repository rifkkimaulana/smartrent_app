...
!(function (e, t) {
  ...
  function l(e, o, c) {
    ...
    return (
      (u || (!u && !c)) &&
        (("body" !== a(o) || p(l)) && (d = o !== n(o) && i(o) ? { scrollLeft: o.scrollLeft, scrollTop: o.scrollTop } : r(o)),
              ...
              s.orderedModifiers.forEach(function (e) {
                ...
                (n = void 0 === n ? {} : n),
                  "function" == typeof (e = e.effect) &&
                    ((t = e({ state: s, name: t, instance: p, options: n })), f.push(t || function () {}));
              }),
              p.update()
            );
          },
              ...
              if (k(t, (e = e.popper)))
                for (
                  ...
                  if (!0 === s.reset) (s.reset = !1), (t = -1);
                    ...
                    (r = void 0 === r ? {} : r),
                      (n = n.name),
                      "function" == typeof e && (s = e({ state: s, options: r, name: n, instance: p }) || s);
                  }
            }
          },
          update: b(function () {
  ...
  function W(e) {
    var t,
      ...
      p = e.adaptive;
    e.roundOffsets
      ? ((e = window.devicePixelRatio || 1), (e = { x: Math.round(a.x * e) / e || 0, y: Math.round(a.y * e) / e || 0 }))
      : (e = a);
    var l = e;
    ...
    return (
      ...
      c
        ? Object.assign(
            ...
            (d[m] = u ? "0" : ""),
            (d.transform =
              2 > (v.devicePixelRatio || 1) ? "translate(" + e + "px, " + l + "px)" : "translate3d(" + e + "px, " + l + "px, 0)"),
            d)
          )
    ...
    Q = {
      ...
      fn: function (e) {
        ...
        var a = n.tetherOffset,
          s = void 0 === a ? 0 : a;
        (n = L(t, { boundary: n.boundary, rootBoundary: n.rootBoundary, padding: n.padding, altBoundary: n.altBoundary })),
          (a = y(t.placement));
      ...
      effect: function (e) {
        ...
        if (((r = void 0 === r ? "[data-popper-arrow]" : r), (n = void 0 === (n = n.padding) ? 0 : n), null != r)) {
          ...
          O(t.elements.popper, r) &&
            ((t.elements.arrow = r), (t.modifiersData[e + "#persistent"] = { padding: D("number" != typeof n ? n : P(n, T)) }));
        }
      },
      requires: ["popperOffsets"],
      ...
      return {
        ...
        start: function (o, r, s, a, u) {
          ...
          (i = u),
            ...
            E(e, { transition: "transform " + f + "ms " + c.easing, transform: "translate(" + a.x + "px," + a.y + "px)" });
        },
      };
    },
    W = function (t, n) {
      ...
      function c() {
        ...
        r.each(function (t) {
          E(t.container, { height: e }),
            E(t.slide, { width: n.autoWidth ? null : f(a.slideWidth(t.index)), height: t.container ? null : e });
        }),
          t.emit("resized");
      }
      return a;
  ...
  return (function (e) {
                ...
                if ("undefined" != typeof Promise) {
                  ...
                  (t.url = t.responseURL = (0, v.getCurrentUrl)()),
                    ...
                    window.history.replaceState(
                      Object.assign({}, window.history.state, { url: window.location.href, random: Math.random(), source: "swup" }),
                      document.title,
                      ...
                      ? (this.triggerEvent("samePageWithHash", e),
                        null != document.querySelector(t.getHash())
                          ? history.replaceState(
                              { url: t.getAddress() + t.getHash(), random: Math.random(), source: "swup" },
                              document.title,
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = function (e) {
          window.history.pushState(
            { url: e || window.location.href.split(window.location.hostname)[1], random: Math.random(), source: "swup" },
    ...
    function (e, t, n) {
      ...
      t.default = function (e, t) {
        ...
        var l = { title: n.querySelector("title").innerText, pageClass: n.querySelector("body").className, originalContent: e, blocks: o };
            ...
            i(e, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    this.link.getAttribute("xlink:href") && (e = this.link.getAttribute("xlink:href")), "/" !== e[0] && (e = "/" + e), e
                  );
                },
              },
              {
    ...
    function (e, t, n) {
      ...
      t.default = function (e, t) {
        ...
        window.location.pathname !== o.getPath() &&
          ...
          (t && !this.options.animateHistoryBrowsing) || document.documentElement.classList.add("is-rendering"),
        ...
        if (
          ...
          setTimeout(function () {
            (t && !n.options.animateHistoryBrowsing) ||
              (n.triggerEvent("animationInStart"), document.documentElement.classList.remove("is-animating"));
          }, 10),
          !t || this.options.animateHistoryBrowsing)
        ) {
          ...
          Promise.all(s).then(function () {
            n.triggerEvent("animationInDone"),
              ...
              document.documentElement.className.split(" ").forEach(function (e) {
                (new RegExp("^to-").test(e) || "is-changing" === e || "is-rendering" === e || "is-popstate" === e) &&
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.use = function (e) {
          if (e.isSwupPlugin)
            return this.plugins.push(e), (e.swup = this), "function" == typeof e._beforeMount && e._beforeMount(), e.mount(), this.plugins;
    ...
    function (e, t, r) {
      ...
      var v = (function (e) {
        ...
        function t() {
          ...
          return (
            (o =
              ((r = ((n = d(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(u)))), n)),
